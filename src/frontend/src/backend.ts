...
export class Backend implements backendInterface {
    ...
    async adminCreateUser(arg0: Principal, arg1: string, arg2: string, arg3: string, arg4: AppRole, arg5: string): Promise<UserProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.adminCreateUser(arg0, arg1, arg2, arg3, to_candid_AppRole_n8(this._uploadFile, this._downloadFile, arg4), arg5);
    ...
    async registerUser(arg0: string, arg1: string, arg2: string, arg3: AppRole, arg4: string): Promise<UserProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.registerUser(arg0, arg1, arg2, to_candid_AppRole_n8(this._uploadFile, this._downloadFile, arg3), arg4);
                return from_candid_UserProfile_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "checker" in value ? AppRole.checker : "admin" in value ? AppRole.admin : "teacher" in value ? AppRole.teacher : value;
}
...
function to_candid_AppRole_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AppRole): _AppRole {
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AppRole): {
    checker: null;
} | {
    admin: null;
} | {
